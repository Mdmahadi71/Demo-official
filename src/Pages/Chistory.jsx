            ...
            <div className="">
              ...
              <div className="">
                <h2 className=' font-normal text-[12px] text-black'>রংপুর জেলার পীরগঞ্জ উপজেলার একটি প্রাচীন জনপদ,এই জনপদ,এই জনপদ শাহ ইসমাইল গাজী (রা:) এবং মধ্যযুগীয় 
                   ...
                   বর্তমান প্রতিষ্ঠানটি এই উপজেলার বৃহৎ শিক্ষা প্রতিষ্ঠান হিসাবে শিক্ষা কার্যক্রম পরিচালনা করে আসছে।
                   শাহ্‌ আব্দুর রউফ কলেজ ১৯৭০ খ্রি. সালে স্থাপিত হয়ে সুনামের সাথে অদ্যবধি শিক্ষা কার্যক্রম পরিচালনার করে আসেছে। বর্তমান অত্র প্রতিষ্ঠানে 
                   উচ্চ মাধ্যমিক পর্যায়ে বিজ্ঞান, মানবিক ও ব্যবসায় শিক্ষায় শাখা, ডিগ্রী পর্যায়ে বি.এ, বিএসএস, বিএসসি সম্মান কোর্স বাংলা ইসলামের ইতিহাস ও
                   সংস্কৃতি, রাষ্ট্রবিজ্ঞান, ভূগোল ও পরিবেশ এবং উদ্ভিদবিদ্যা বিষয় চালু রযেছে। বর্তমান অত্র শিক্ষার প্রতিষ্ঠানের প্রায় ২৫০০ জন ছাত্র-ছাত্রী অধ্যয়নরত।</h2>
              </div>
            </div>
          </div>
