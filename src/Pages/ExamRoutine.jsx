            ...
            <Container>
                <div className=" lg:flex justify-between">
                    <div className="lg:w-[59%]">
                        <div className=" py-5">
                            <h2 className=' font-semibold text-[25px] text-black'>পরীক্ষার রুটিন</h2>
                        </div>
                        ...
                        <div class=" mx-auto my-8">
                            <table class="min-w-full bg-white">
                                <thead>
                                    <tr>
                                        <th class="py-2 px-4 border-b-2 border-gray-300 bg-emerald-400  text-[14px] text-white text-left text-sm font-semibold"> নাম</th>
                                        <th class="py-2 px-4 border-b-2 border-gray-300 bg-emerald-400  text-[14px] text-white text-left text-sm font-semibold">প্রকাশের তারিখ</th>
                                        <th class="py-2 px-4 border-b-2 border-gray-300 bg-emerald-400  text-[14px] text-white text-left text-sm font-semibold">ডাউনলোড</th>
                                    </tr>
                                </thead>
