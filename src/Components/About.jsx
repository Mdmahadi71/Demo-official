            ...
            <div className="w-[40%] py-3">
                <div className=" pt-[30px]">
                    ...
                    <div className=" py-[30px]  ">
                        <input type="text" className=' w-[290px] h-[50px] border-[1px] outline-none border-gray-400 ' name="" id="" />
                        <button className=' py-[8px] px-[26px] bg-black text-white ml-3'><FaSearch/></button>
                    </div>
